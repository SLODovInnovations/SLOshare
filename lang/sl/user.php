...
return [
    ...
    'bookmarks'                            => 'Zaznamki',
    'bounty-given'                         => 'Darovana nagrada',
    'bounty-received'                      => 'Bounty Prejeto',
    'can-chat'                             => 'Lahko klepetate',
    ...
    'certified-banker'                     => 'Pooblaščeni bankir',
    'certified-banker-desc'                => 'Ima 50.000 ali več BON v banki',
    'certified-downloader'                 => 'Certificiran prenosnik',
    'certified-downloader-desc'            => 'Preneseno 100 ali več torentov!',
    'certified-seeder'                     => 'Certificirana Seeder',
    'certified-seeder-desc'                => 'Seeding 150 ali več Torrents!',
    'change-email'                         => 'Spremeni E-Mail',
    'change-email-help'                    => 'Po spremembi E-Mail boste morali ponovno potrditi svoj račun',
    'change-password'                      => 'Spremeni geslo',
    'change-password-help'                 => 'Po spremembi gesla se boste morali ponovno prijaviti',
    'client-connectable-state'     		   => '{0}Ne|{1}Da',
    'client-list'                  		   => 'Odjemalci',
    ...
    'credited-upload'                      => 'Kreditni prenos',
    'current-password'                     => 'Trenutno geslo',
    'custom-title'                         => 'Naslov po meri',
    'deactivate'                   		   => 'Deaktiviraj',
    'deactivate-all'               		   => 'Deaktiviraj vse',
    'delete'                               => 'Izbriši uporabnika',
    'delete-all'                   		   => 'Izbriši vse',
    'deleted-by'                   		   => 'Izbrisal',
    'deleted-on'                   		   => 'Izbrisano vklopljeno',
    ...
    'follow'                               => 'Sledite',
    'follow-already'                       => 'Tega uporabnika že spremljate',
    'follow-not-to-begin-with'             => 'Za začetek ne spremljate tega uporabnika',
    'follow-revoked'                       => 'Ne spremljate več %s',
    'follow-user'                          => 'Zdaj spremljate %s',
    'follow-yourself'                      => 'Dober poskus, vendar si žal ne morete slediti.',
    ...
    'formats-are-supported'                => 'Podprti so formati: .jpg , .jpeg , .bmp , .png , .tiff , .gif',
    ...
    'id-permissions'                       => 'ID & Dovoljenja',
    'image'                                => 'Slika',
    'important'                            => 'Pomembno',
    'important-info'                       => 'Pomembne informacije',
    'information'                          => 'Informacije',
    'invited-by'                           => 'Povabilo',
    'invite-already-sent'                  => 'E-Mail naslov, na katerega poskušate poslati povabilo, je že bil poslan.',
    'invite-already-used'                  => 'Povabilo, ki ga poskušate znova poslati, je bilo že uporabljeno.',
    'invite-friend'                        => 'Povabi prijatelja (E-Mail + sporočilo je obvezno)',
    'invite-resent-success'                => 'Povabilo je bilo uspešno ponovno poslano!',
    'invite-sent-success'                  => 'Povabilo je bilo uspešno poslano!',
    ...
    'my-requested'                         => 'Moji Zahtevki',
    'my-security'                          => 'Moja Varnost',
    'my-security-settings'                 => 'Moje Varnostne nastavitve',
    'my-seedboxes'                         => 'Moji Sejalni predali',
    'my-settings'                          => 'Moje Nastavitve',
    'my-uploads'                           => 'Moji Naloženi Torrenti',
    'my-wishlist'                          => 'Moj Seznam želja',
    'no-ban'                               => 'Za tega uporabnika v bazi podatkov ni prepovedi!',
    'no-logs'                              => 'Za uporabnika ni vpisanih dnevnikov v bazi podatkov!',
    'no-seedboxes'                         => 'Ni nabiralnikov semen',
    'no-soft-warning'                      => 'Za tega uporabnika v bazi podatkov ni opozoril o mehko izbrisanih!',
    'no-warning'                           => 'V bazi podatkov za tega uporabnika ni opozoril!',
    'not-authorized'                       => 'Nimate dovoljenja za ogled te strani. Ta član raje skriva kot ninja!',
    'not-enough-invites'                   => 'Nimate dovolj povabil!',
    'not-satisfied-not-immune'	           => 'Ni zadovoljen / Ni imun',
    'note'                                 => 'Opomba',
    ...
    'public-info'                          => 'Informacija',
    'peason'                               => 'Razlog',
    'reason-ban'                           => 'Razlog za prepoved',
    'reason-unban'                         => 'Razlog za odpoved',
    ...
    'reset-api-token'                      => 'Ponastavi žeton API',
    'reset-api-help'                       => 'Po ponastavitvi žetona API boste morali posodobiti vse skripte ali aplikacije, ki jih uporabljate z novim žetonom',
    ...
    'seedbox-added-success'                => 'Seedbox Uspešno dodan!',
    'seedbox-deleted-success'              => 'Seedbox Je bil uspešno izbrisan',
    'seedboxes'                            => 'Seedboxes',
    'seeding-size'                         => 'Velikost sejanja',
    'seeds'                                => 'Semena Torrentov',
    'send-invite'                          => 'Pošlji povabilo',
    'sender'                               => 'Pošiljatelj',
    'settings'                             => 'Nastavitve',
    'show-passkey'                         => 'Pokaži PID',
    'soft-deleted-warnings'                => 'Mehko izbrisana opozorila',
    ...
    'top-bountied'                         => 'Vrhunski Bankir',
    'top-completed'                        => 'Vrhunsko Dokončano',
    'top-downloaders-data'                 => 'Najbolj prenašalci (podatki)',
    'top-dead'                             => 'Top Dead',
    'top-dying'                            => 'Top Dying',
    'top-leeched'                          => 'Top Leeched',
    'top-leechers'                         => 'Top Pijavke',
    'top-leechers-count'                   => 'Top Pijavke (število)',
    'top-seeded'                           => 'Top Pijavka',
    'top-seeders'                          => 'Top Pijavke',
    ...
    'total-download'                       => 'Skupaj Prenešeno',
    'total-downloads'                      => 'Skupaj Prenosov',
    'total-leeching'                       => 'Skupaj Prenesel',
    'total-seeding'                        => 'Skupaj Sejanje',
    'total-seedtime'                       => 'Skupni čas sejanja',
    'total-upload'                         => 'Skupaj Naloženo',
    'total-uploads'                        => 'Skupaj Naloženo',
    ...
    */
    ...
    'close'                                => 'Zapri',
    'noteuser'                             => 'Opomba Uporabnika',
    'save'                                 => 'Shrani',
    'ban-user'                             => 'BAN',
    'unban-user'                           => 'Prekliči BAN uporabnika',
    'unban-reason'                         => 'Razlog za preklic BAN',
