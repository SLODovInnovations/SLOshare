...
@section('title')
    <title>{{ $user->username }} - Nastavitve - {{ __('common.members') }}</title>
@endsection
        ...
        <div class="panel__body">
            ...
            >
                ...
                <fieldset class="form form__fieldset">
                    <legend class="form__legend">Slog</legend>
                    <p class="form__group">
                    ...
                    <p class="form__group">
                        ...
                        <label class="form__label form__label--floating" for="custom_css">
                            Zunanja tabela slogov CSS (skupine na zgornji temi)
                        </label>
                    </p>
                    <p class="form__group">
                        <input
                        ...
                        <label class="form__label form__label--floating" for="standalone_css">
                            Samostojna tabela slogov CSS (uporabljena ni nobena tema spletnega mesta)
                        </label>
                    </p>
                </fieldset>
                ...
                <fieldset class="form form__fieldset">
                    ...
                    <p class="form__group">
                        <select id="show_poster" class="form__select" name="torrent_layout" required>
                            <option class="form__option" value="0" @selected($user->torrent_layout === 0)>Seznam Torrentov</option>
                            <option class="form__option" value="1" @selected($user->torrent_layout === 1)>Torrent kartice</option>
                            <option class="form__option" value="2" @selected($user->torrent_layout === 2)>Torrent skupine</option>
                        </select>
                        <label class="form__label form__label--floating" for="torrent_layout">
                            Privzeta postavitev torrenta
                        </label>
                    </p>
                    <p class="form__group">
                    ...
                    <p class="form__group">
                        <label class="form__label">
                            ...
                            />
                            Prikaži plakate v pogledu seznama torrentov
                        </label>
                    </p>
                </fieldset>
                <p class="form__group">
