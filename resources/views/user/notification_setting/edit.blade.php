...
@section('title')
    <title>{{ $user->username }} - {{ __('user.notification') }} - {{ __('common.members') }}
    </title>
@endsection
    ...
    <section class="panelV2">
        ...
        <div class="panel__body">
            ...
            >
                ...
                <fieldset class="form__fieldset">
                    <legend class="form__legend">Omembe</legend>
                    <p class="form__group">
                        <label class="form__label">
                ...
                <h3>Blokiraj vsa obvestila iz izbranih skupin.</h3>
