                                        ...
                                        >
                                            ...
                                            <button 
                                                x-on:click.prevent="Swal.fire({
                                                    ...
                                                    text: 'Ali ste prepričani, da želite deaktivirati to opozorilo: {{ $warning->reason }}?',
                                                    icon: 'warning',
                                    ...
                                    <li class="data-table__action">
                                        ...
                                        >
                                            ...
                                            <button 
                                                x-on:click.prevent="Swal.fire({
                                                    title: 'Ali si prepričan?',
                                                    text: 'Ali ste prepričani, da želite izbrisati to opozorilo: {{ $warning->reason }}?',
                                                    icon: 'warning',
                                                    showConfirmButton: true,
                                                    showCancelButton: true,
                                                }).then((result) => {
                                    ...
                                    <li class="data-table__action">
                                        ...
                                        >
                                            ...
                                            <button 
                                                x-on:click.prevent="Swal.fire({
                                                    title: 'Ali si prepričan?',
                                                    text: 'Ali ste prepričani, da želite obnoviti to opozorilo: {{ $warning->reason }}?',
                                                    icon: 'warning',
                                                    showConfirmButton: true,
                                                    showCancelButton: true,
                                                }).then((result) => {
