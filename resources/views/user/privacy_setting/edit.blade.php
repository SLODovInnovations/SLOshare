...
@section('title')
    <title>{{ $user->username }} - Zasebnost - {{ __('common.members') }}</title>
@endsection
    ...
    <section class="panelV2">
        ...
        <div class="panel__body">
            ...
            >
                ...
                <fieldset class="form__fieldset">
                    <legend class="form__legend">Sledilci</legend>
                    <p class="form__group">
                        <label class="form__label">
                ...
                <fieldset class="form__fieldset">
                    <legend class="form__legend">Forumi</legend>
                    <p class="form__group">
                        <label class="form__label">
                ...
                <fieldset class="form__fieldset">
                    <legend class="form__legend">Zahteve</legend>
                    <p class="form__group">
                        <label class="form__label">
                ...
                <fieldset class="form__fieldset">
                    <legend class="form__legend">Torrenti</legend>
                    <p class="form__group">
                        <label class="form__label">
                ...
                <fieldset class="form__fieldset">
                    <legend class="form__legend">Drugo</legend>
                    <p class="form__group">
                        <label class="form__label">
                ...
                <h3>Skrijte svoje možnosti profila pred izbranimi skupinami.</h3>
                <div class="form__group--short-horizontal">
                    ...
                    <fieldset class="form__fieldset">
                        <legend class="form__legend">Dosežki</legend>
                        @foreach($groups as $group)
                            <p class="form__group">
                                <label class="form__label">
                                    <input
