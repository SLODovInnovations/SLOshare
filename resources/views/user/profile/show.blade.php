                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="text-info" title="Privzeti začetni prenos">{{ App\Helpers\StringHelper::formatBytes($def_download , 2) }}</span> +
                                        <span class="text-red" title="{{ __('user.download-true') }}">{{ App\Helpers\StringHelper::formatBytes($his_down , 2) }}</span> −
                                        <span class="text-green" title="Freeleech prenosi">{{ App\Helpers\StringHelper::formatBytes($free_down , 2) }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="text-info" title="Privzeti začetni prenos">{{ App\Helpers\StringHelper::formatBytes($def_upload , 2) }}</span> +
                                        <span class="text-green" title="{{ __('user.upload-true') }}">{{ App\Helpers\StringHelper::formatBytes($his_upl , 2) }}</span> +
                                        <span class="text-info" title="Nalaganje iz množiteljev">{{ App\Helpers\StringHelper::formatBytes($multi_upload , 2) }}</span> +
                                        <span class="text-orange" title="{{ __('user.upload-bon') }}">{{ App\Helpers\StringHelper::formatBytes($bonupload , 2) }}</span> +
                                        <span class="text-pink" title="Ročno dodano ali razno">{{ App\Helpers\StringHelper::formatBytes($man_upload , 2) }}</span>
                                    </td>
                                </tr>
                                <tr>
