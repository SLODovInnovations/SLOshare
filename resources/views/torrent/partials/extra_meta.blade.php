        ...
        <h4>
            <nav>
                ...
                <a :class="{ 'active': 'recommendations' === tab }"
                   @click.prevent="tab = 'recommendations'; window.location.hash = 'recommendations'" href="#">SLOshare Priporoča</a>
                |
                <a :class="{ 'active': 'collection' === tab }"
                   @click.prevent="tab = 'collection'; window.location.hash = 'collection'" href="#">Zbirka Filmov</a> |
                <a :class="{ 'active': 'playlists' === tab }"
                   @click.prevent="tab = 'playlists'; window.location.hash = 'playlists'" href="#">Seznami predvajanja</a>
            </nav>
        </h4>
    </div>
