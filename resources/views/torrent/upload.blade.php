        ...
        >
            ...
            <div class="panel__body">
                ...
                >
                    ...
                    <p class="form__group" x-show="cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv'">
                        <select
                            name="resolution_id"
                            id="autores"
                            class="form__select"
                            x-bind:required="cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv'"
                        >
                            <option hidden disabled selected value=""></option>
                    ...
                    <div class="form__group--horizontal" x-show="cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv'">
                        <p class="form__group">
                            ...
                            <input
                                ...
                                inputmode="numeric"
                                pattern="[0-9]*"
                                x-bind:value="(cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv') ? '{{ $tmdb ?: old('tmdb') }}' : '0'"
                                x-bind:required="cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv'"
                            >
                        ...
                        <p class="form__group">
                            ...
                            <input
                                ...
                                inputmode="numeric"
                                pattern="[0-9]*"
                                x-bind:value="(cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv') ? '{{ $imdb ?: old('imdb') }}' : '0'"
                                x-bind:required="cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv'"
                            >
                        ...
                        <!--<p class="form__group">
                            ...
                            <input
                                ...
                                inputmode="numeric"
                                pattern="[0-9]*"
                                x-bind:value="(cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv') ? '{{ old('mal') }}' : '0'"
                                class="form__text"
                                placeholder=""
                            >
                    ...
                    <!--<p class="form__group" x-show="cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv'">
                        ...
                        <input
                            ...
                            id="stream"
                            name="stream"
                            x-bind:value="(cats[cat].type === 'movie' || cats[cat].type === 'tv' || cats[cat].type === 'cartoon' || cats[cat].type === 'cartoontv') ? '1' : '0'"
                            @checked(old('stream'))
                        >
