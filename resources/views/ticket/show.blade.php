                ...
                <div class="col-md-8">
                    <div class="panel panel-chat shoutbox">
                        ...
                        <span class="float-right small text-right">
                            ...
                            <i class="far fa-clock"></i>  {{ $ticket->created_at->format('d.m.Y') }}
                                ...
                                <div class="form-group">
                                    ...
                                    @if(!empty($ticket->closed_at))
                                        <span style="display: inline;"
                                              class="text-danger">{{ __('ticket.closed') }} {{ $ticket->closed_at->format('d.m.Y') }}</span>
                                    @endif
                                        <form style="display: inline;" role="form" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    @if($ticket->priority->name === 'Nizka')
                                        <i class="fas fa-circle text-yellow"></i>
                                    @elseif ($ticket->priority->name === 'Srednja')
                                        <i class="fas fa-circle text-orange"></i>
                                    @elseif ($ticket->priority->name === 'Visoka')
                                    ...
                                    @foreach ($ticket->comments as $comment)
                                        <li class="media" style="border-left: 5px solid rgb(1,188,140);">
                                            <div class="media-body">
                                                ...
                                                <span class="text-muted"><small><em>{{ date('d.m.Y h:i:s', $comment->created_at->getTimestamp()) }} ({{ $comment->created_at->diffForHumans() }})</em></small></span>
                                                <div class="pt-5">
