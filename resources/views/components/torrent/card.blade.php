                ...
                <img
                    ...
                    @switch (true)
                        @case ($torrent->category->movie_meta || $torrent->category->tv_meta)
                            src="{{ isset($meta->poster) ? tmdb_image('poster_mid', $meta->poster) : '/img/SLOshare/movie_no_image_160x240.jpg' }}"
                            @break
                        @case ($torrent->category->cartoon_meta || $torrent->category->cartoontv_meta)
                            src="{{ isset($meta->poster) ? tmdb_image('poster_mid', $meta->poster) : '/img/SLOshare/cartoon_no_image_160x240.jpg' }}"
                            @break
                        ...
                        @case ($torrent->category->music_meta)
                            src="/img/SLOshare/music_no_image_160x240.jpg"
                            @break
                        @case ($torrent->category->no_meta)
                            src="/img/SLOshare/meta_no_image_160x240.jpg"
                            @break
                    @endswitch
