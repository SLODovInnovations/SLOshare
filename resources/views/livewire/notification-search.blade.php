                                        ...
                                        >
                                            ...
                                            <button
                                                x-on:click.prevent="Swal.fire({
                                                    ...
                                                    text: 'Ali ste prepričani, da želite izbrisati to obvestilo: {{ $notification->data['body'] }}?',
                                                    icon: 'warning',
                ...
                <form action="{{ route('notifications.updateall') }}" method="POST" x-data>
                    ...
                    <p class="form__group form__group--horizontal">
                        <button
                            x-on:click.prevent="Swal.fire({
                                title: 'Ali si prepričan?',
                                text: 'Ali ste prepričani, da želite vsa obvestila označiti kot prebrana?',
                                icon: 'warning',
                                showConfirmButton: true,
                                showCancelButton: true,
                            }).then((result) => {
                ...
                <form action="{{ route('notifications.destroyall') }}" method="POST" x-data>
                    ...
                    <p class="form__group form__group--horizontal">
                        <button
                            x-on:click.prevent="Swal.fire({
                                title: 'Ali si prepričan?',
                                text: 'Ali ste prepričani, da želite izbrisati vsa obvestila?',
                                icon: 'warning',
                                showConfirmButton: true,
                                showCancelButton: true,
                            }).then((result) => {
