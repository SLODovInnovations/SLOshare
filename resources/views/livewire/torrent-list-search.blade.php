                                ...
                                <div class="torrent-poster pull-left">
                                    ...
                                    @else
                                        @if(file_exists(public_path().'/files/img/torrent-cover_'.$torrent->id.'.jpg'))
                                            <img src="{{ url('files/img/torrent-cover_' . $torrent->id . '.jpg') }}" class="torrent-poster-img-small" loading="lazy" alt="{{ __('torrent.poster') }}">
                                        @endif
                                    @endif
                                    ...
                                    @if ($torrent->category->music_meta)
                                        @if(file_exists(public_path().'/files/img/torrent-cover_'.$torrent->id.'.jpg'))
                                            <img src="{{ url('files/img/torrent-cover_' . $torrent->id . '.jpg') }}" class="torrent-poster-img-small" loading="lazy" alt="{{ __('torrent.poster') }}">
                                        @else
                                            <img src="/img/SLOshare/music_no_image_holder_90x135.jpg" class="torrent-poster-img-small" loading="lazy" alt="{{ __('torrent.poster') }}">
                                        @endif
                                    @endif
                                    ...
                                    @if ($torrent->category->no_meta)
                                        @if(file_exists(public_path().'/files/img/torrent-cover_'.$torrent->id.'.jpg'))
                                            <img src="{{ url('files/img/torrent-cover_' . $torrent->id . '.jpg') }}" class="torrent-poster-img-small" loading="lazy" alt="{{ __('torrent.poster') }}">
                                        @else
                                            <img src="/img/SLOshare/meta_no_image_holder_90x135.jpg" class="torrent-poster-img-small" loading="lazy" alt="{{ __('torrent.poster') }}">
                                        @endif
                                    @endif
                                </div>
