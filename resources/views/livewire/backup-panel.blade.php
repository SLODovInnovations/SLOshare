<div style="display: flex; flex-direction: column; gap: 1rem;">
    <section class="panelV2" x-data>
        <header class="panel__header">
            <h2 class="panel__heading">SLOshare Backup Manager</h2>
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                ...
                <tr>
                    ...
                    <th scope="col">Zdravo</th>
                    <th scope="col">Količina varnostnih kopij</th>
                    <th scope="col">Najnovejša varnostna kopija</th>
                    <th scope="col">Rabljena shramba</th>
                </tr>
                </thead>
                <tbody>
    ...
    <section class="panelV2">
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                ...
                @empty
                    <tr>
                        <td colspan="4">Ni varnostnih kopij</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <h5 class="modal-title mb-3">Izbriši varnostno kopijo</h5>
                        @if($deletingFile)
                            <span class="text-muted">
                                Ali ste prepričani, da želite izbrisati varnostno kopijo, ustvarjeno na {{ $deletingFile['date'] }} ?
                            </span>
                        @endif
                    </div>
    ...
    <script nonce="{{ SLOYakuza\SecureHeaders\SecureHeaders::nonce('script') }}">
      document.addEventListener('livewire:load', function () {
        ...
        const backupFun = function (option = '') {
          Swal.fire({
            title: '<strong style=" color: rgb(17,17,17);">Uspešno</strong>',
            icon: 'success',
            html: 'Ustvarjanje nove varnostne kopije v ozadju...' + (option ? ' (' + option + ')' : ''),
