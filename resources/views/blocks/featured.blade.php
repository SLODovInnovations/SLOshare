            ...
            <div id="myCarousel" class="keen-slider">
                ...
                @foreach ($featured as $key => $feature)
                    ...
                    @if ($feature->torrent->category->movie_meta)
                        ...
                        @endif
                    @endif
                    @if ($feature->torrent->category->cartoon_meta)
                        @if ($feature->torrent->tmdb || $feature->torrent->tmdb != 0)
                            @php $meta = App\Models\Cartoon::with('genres', 'cast', 'companies', 'collection')->where('id', '=', $feature->torrent->tmdb)->first() @endphp
                        @endif
                    @endif
                    ...
                    <div class="keen-slider__slide">
                        <div class="movie-image">
                            ...
                            @if ($feature->torrent->category->tv_meta || $feature->torrent->category->movie_meta || $feature->torrent->category->cartoon_meta)
                            ...
                            <div class="movie-content">
                                ...
                                <div class="movie-desc">
                                    @if ($feature->torrent->category->tv_meta ||
                                         ...
                                         $feature->torrent->category->cartoon_meta)
