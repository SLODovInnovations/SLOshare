                    ...
                    @foreach ($featured as $feature)
                        ...
                        @php
                            $meta = match(1) {
                                ...
                                $feature->torrent->category->cartoon_meta => App\Models\Cartoon::query()->with('genres', 'cast', 'companies', 'collection')->where('id', '=', $feature->torrent->tmdb ?? 0)->first(),
                                $feature->torrent->category->cartoontv_meta => App\Models\CartoonTv::query()->with('genres', 'networks', 'seasons')->where('id', '=', $feature->torrent->tmdb ?? 0)->first(),
