        ...
        <ul class="nav nav-tabs-user mb-5-user" role="tablist">
            ...
            <li class="">
                <a href="#recommended-tvseries" role="tab" data-toggle="tab" aria-expanded="true">
                    <i class="{{ config('other.font-awesome') }} fa-film"></i> {{ __('sloshare.home-tvseries-title') }}
                </a>
            </li>
            <li class="">
                <a href="#recommended-cartoons" role="tab" data-toggle="tab" aria-expanded="true">
                    <i class="{{ config('other.font-awesome') }} fa-film"></i> {{ __('sloshare.home-cartoons-title') }}
                </a>
            </li>
            <li class="">
                <a href="#recommended-games" role="tab" data-toggle="tab" aria-expanded="true">
                    <i class="{{ config('other.font-awesome') }} fa-film"></i> {{ __('sloshare.home-game-title') }}
                </a>
            </li>
        </ul>
    <!-- Buttons -->
