			            ...
			            <div class="gallery-item"
                            ...
                            @endif
					            ...
					            <div class="release-info-container">
						            ...
						            <div class="release-info-meta">{{ __('sloshare.added') }} {{ $seed->created_at->format('d.m.Y') }} | {{ $seed->created_at->format('H:m') }}</div>
			            ...
			            <div class="gallery-item"
                            ...
                            @endif
					            ...
					            <div class="release-info-container">
						            ...
						            <div class="release-info-meta">{{ __('sloshare.added') }} {{ $leech->created_at->format('d.m.Y') }} | {{ $leech->created_at->format('H:m') }}</div>
