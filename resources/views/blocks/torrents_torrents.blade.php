            ...
            @endif
				...
				<div class="release-info">
					...
					<div class="release-info-container">
						...
						<div class="release-info-meta">{{ __('sloshare.added') }} {{ date('d.m.Y', $videos->created_at->getTimestamp()) }} | {{ date('H:m:s', $videos->created_at->getTimestamp()) }}</div>
            ...
            @endif
				...
				<div class="release-info">
					...
					<div class="release-info-container">
						...
						<div class="release-info-meta">{{ __('sloshare.added') }} {{ date('d.m.Y', $tv->created_at->getTimestamp()) }} | {{ date('H:m:s', $tv->created_at->getTimestamp()) }}</div>
			...
			<div class="gallery-item" style="background-image: url('{{ isset($meta->cover) ? 'https://images.igdb.com/igdb/image/upload/t_cover_small_2x/'.$meta->cover['image_id'].'.png' : '/img/poster/poster-torrent-1.png' }}');">
				<div class="release-info">
					...
					<div class="release-info-container">
						...
						<div class="release-info-meta">{{ __('sloshare.added') }} {{ date('d.m.Y', $games->created_at->getTimestamp()) }} | {{ date('H:m:s', $games->created_at->getTimestamp()) }}</div>
            ...
            @endif
				<div class="release-info">
					...
					<div class="release-info-container">
						...
						<div class="release-info-meta">{{ __('sloshare.added') }} {{ date('d.m.Y', $application->created_at->getTimestamp()) }} | {{ date('H:m:s', $application->created_at->getTimestamp()) }}</div>
            ...
            @endif
				...
				<div class="release-info">
					...
					<div class="release-info-container">
						...
						<div class="release-info-meta">{{ __('sloshare.added') }} {{ date('d.m.Y', $cartoon->created_at->getTimestamp()) }} | {{ date('H:m:s', $cartoon->created_at->getTimestamp()) }}</div>
            ...
            @endif
				<div class="release-info">
					...
					<div class="release-info-container">
						...
						<div class="release-info-meta">{{ __('sloshare.added') }} {{ date('d.m.Y', $x->created_at->getTimestamp()) }} | {{ date('H:m:s', $x->created_at->getTimestamp()) }}</div>
