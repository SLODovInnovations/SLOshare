            ...
            <div class="row">
                ...
                @foreach($torrents as $t)
                    ...
                    @if ($t->torrent->category->movie_meta)
                        ...
                        @endif
                    @endif
                    @if ($t->torrent->category->cartoon_meta)
                        @if ($t->torrent->tmdb || $t->torrent->tmdb != 0)
                            @php $meta = App\Models\Cartoon::with('genres', 'cast', 'companies', 'collection')->where('id', '=', $t->torrent->tmdb)->first() @endphp
                        @endif
                    @endif
                    <div class="col-md-6">
                        <div class="card is-torrent">
                            ...
                            <div class="card_body">
                                <div class="body_poster">
                                    @if ($t->torrent->category->movie_meta || $t->torrent->category->tv_meta $t->torrent->category->cartoon_meta)
                                ...
                                <div class="body_description">
                                    <h3 class="description_title">
                                        <a href="{{ route('torrent', ['id' => $t->torrent->id]) }}">{{ $t->torrent->name }}
                                            @if($t->torrent->category->movie_meta || $t->torrent->category->cartoon_meta || ($t->torrent->category->tv_meta && isset($t->torrent->meta) && $meta->releaseYear))
                                    ...
                                    @if ($t->torrent->category->movie_meta && isset($meta) && $meta->genres)
                                        ...
                                        @endforeach
                                    @endif
                                    @if ($t->torrent->category->cartoon_meta && isset($meta) && $meta->genres)
                                        @foreach ($meta->genres as $genre)
                                            <span class="genre-label">{{ $genre->name }}</span>
                                        @endforeach
                                    @endif
                                    ...
                                    <p class="description_plot">
                                        @if($t->torrent->category->movie_meta || $t->torrent->category->cartoon_meta || ($t->torrent->category->tv_meta && $meta && $meta->plot))
                                            {{ $meta->overview ?? '' }}
                                        @endif
                                    </p>
                                </div>
