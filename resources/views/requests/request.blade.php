    ...
    <div class="container">
        ...
        @else
            ...
            <div class="block single">
                    ...
                    <div class="col-sm-12">
                        <div class="pull-right">
                            ...
                            @if ($torrentRequest->filled_hash == null)
                                <button class="btn btn-success btn-vote-request" data-toggle="modal"
                            ...
                            @endif @if ($user->group->is_modo && $torrentRequest->filled_hash == null)
                                <a class="btn btn-warning"
                                   href="{{ route('edit_request', ['id' => $torrentRequest->id]) }}" role="button"><i
                                            ...
                                            aria-hidden="true"></i> {{ __('request.edit-request') }}</a>
                ...
                @if ($torrentRequest->category->cartoon_meta)
                ...
                <div class="table-responsive mt-20">
                    <table class="table table-condensed table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $torrentRequest->resolution->name ?? 'Brez resolucije' }}
                            </td>
                        </tr>
                        <!--<tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($torrentRequest->claimed == null && $torrentRequest->filled_hash == null)
                                    ...
                                    @if ($torrentRequest->category->movie_meta || $torrentRequest->category->tv_meta  || $torrentRequest->category->cartoon_meta)
                                    ...
                                    @else @foreach ($comments as $comment)
                                        <li class="media" style="border-left: 5px solid #01bc8c;">
                                            <div class="media-body">
                                                ...
                                                @endif
                                                <span class="text-muted"><small><em>{{ date('d.m.Y', $voter->created_at->getTimestamp()) }}</em></small></span>
