...
@if (auth()->user()->group->is_admin)
                <div class="modal-body text-center">
                    ...
                    <fieldset>
                        ...
                        <label>
                            <input class="form-control" type="number" tabindex="3" name='bonus_value' min='0'
                                   value="0">
                        </label>
                        <p>Anonimna Nagrada?</p>
...
@endif
                ...
                <div class="modal-footer">
                    <div class="text-center">
                        ...
                        <button type="submit" title="{{ __('request.dont-have-bps') }}"
                                class="btn btn-success">{{ __('request.vote') }}</button>
                    </div>
                </div>
            </form>
        </div>
