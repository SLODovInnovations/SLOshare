...
@section('title')
    <title>{{ __('staff.seedboxes') }} - {{ __('staff.staff-dashboard') }}</title>
@endsection
    ...
    <section class="panelV2">
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                                    ...
                                    >
                                        ...
                                        <button
                                            x-on:click.prevent="Swal.fire({
                                                ...
                                                text: 'Ali ste prepričani, da želite izbrisati to seedbox: {{ $seedbox->ip }} (owned by {{ $seedbox->user->username }})?',
                                                icon: 'warning',
                ...
                @empty
                    <tr>
                        <td colspan="5">Brez seedboxes</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
