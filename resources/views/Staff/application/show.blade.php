...
@section('title')
    <title>Aplikacije - {{ __('staff.staff-dashboard') }}</title>
@endsection
                            ...
                            >
                                ...
                                <p class="form__group">
                                    <textarea
                                        ...
                                        name="deny"
                                        required
                                    >Nezadostni dokazi.</textarea>
                                    <label class="form__label form__label--floating for="message">Sporočilo o zavrnitvi</label>
                                </p>
                                <p class="form__group">
                                    <button class="form__button form__button--filled">
                                        {{ __('request.reject') }}
