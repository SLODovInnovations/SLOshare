...
@section('title')
    <title>Moderation - {{ __('staff.staff-dashboard') }}</title>
@endsection
    ...
    <section class="panelV2">
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                ...
                @empty
                    <tr>
                        <td colspan="8">Ni čakajočih torrentov</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
    ...
    <section class="panelV2">
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                ...
                @empty
                    <tr>
                        <td colspan="9">Brez preloženih torrentov</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
    ...
    <section class="panelV2">
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                ...
                @empty
                    <tr>
                        <td colspan="9">Ni zavrnjenih torrentov</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
