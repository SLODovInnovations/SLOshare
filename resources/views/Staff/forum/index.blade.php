...
@section('main')
    <section class="panelV2">
        <header class="panel__header">
            <h2 class="panel__heading">Forum</h2>
                                    ...
                                    >
                                        ...
                                        <button
                                            x-on:click.prevent="Swal.fire({
                                                ...
                                                text: 'Ali ste prepričani, da želite izbrisati to kategorijo foruma?: {{ $category->name }}?',
                                                icon: 'warning',
                                    ...
                                    <li class="data-table__action">
                                        ...
                                        >
                                            ...
                                            <button
                                                x-on:click.prevent="Swal.fire({
                                                    title: 'Ali si prepričan?',
                                                    text: 'Ali ste prepričani, da želite izbrisati ta forum?: {{ $forum->name }}?',
                                                    icon: 'warning',
                                                    showConfirmButton: true,
                                                    showCancelButton: true,
                                                }).then((result) => {
