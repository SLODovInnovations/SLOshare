...
@section('title')
    <title>{{ __('common.user') }} {{ __('common.edit') }} - {{ __('staff.staff-dashboard') }}</title>
@endsection
                        ...
                        <p class="form__group">
                            <button
                                x-on:click.prevent="Swal.fire({
                                    ...
                                    text: 'Ali ste prepričani, da želite spremeniti geslo tega uporabnika?',
                                    icon: 'warning',
                                            ...
                                            <li class="data-table__action">
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        x-on:click.prevent="Swal.fire({
                                                            title: 'Ali si prepričan?',
                                                            text: 'Ali ste prepričani, da želite izbrisati to opombo?: {{ $note->message }}',
                                                            icon: 'warning',
                                                            showConfirmButton: true,
                                                            showCancelButton: true,
                                                        }).then((result) => {
