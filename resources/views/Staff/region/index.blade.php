...
@section('main')
    <section class="panelV2">
        <header class="panel__header">
            <h2 class="panel__heading">Uredi Torrent regijo</h2>
                                ...
                                <li class="data-table__action" x-data="{ open: false }">
                                    ...
                                    <dialog class="dialog" x-ref="dialog">
                                        <h4 class="dialog__heading">
                                            Izbriši Torrent Regijo: {{ $region->name }}
                                        </h4>
                                        <form
                                            class="dialog__form"
                                            method="POST"
                                        ...
                                        >
                                            ...
                                            @method('DELETE')
                                            <p class="form__group">
                                                Obstoječi torrent na spletnem mestu morda že uporablja to regijo. Bi ga radi spremenili?
                                            </p>
