...
@section('title')
    <title>Poročila - {{ __('staff.staff-dashboard') }}</title>
@endsection
...
@section('main')
    ...
    @if (count($urls) > 0)
        <section class="panelV2">
            <h2 class="panel__heading">Referenčne povezave:</h2>
            <div class="panel__body">
    ...
    @if ($report->solved)
        <section class="panelV2">
            <h2 class="panel__heading">Razsodba</h2>
            <div class="panel__body">{{ $report->verdict }}</div>
        </section>
    @else
        <section class="panelV2">
            <h2 class="panel__heading">Razrešiti {{ __('common.report') }}</h2>
            <div class="panel__body">
                <form
                    class="form"
                    method="POST"
...
@section('sidebar')
    <section class="panelV2">
        <h2 class="panel__heading">Prijavljeno {{ __('common.user') }}</h2>
        <div class="panel__body">
    ...
    <section class="panelV2">
        <h2 class="panel__heading">Rešil</h2>
        <div class="panel__body">
            @if ($report->solved)
