...
@section('title')
    <title>{{ __('common.upload') }} {{ __('common.subtitle') }}</title>
@endsection
    ...
    <li>
        <a href="{{ route('subtitles.create', ['torrent_id' => $torrent->id]) }}" itemprop="url"
           class="l-breadcrumb-item-link">
            <span itemprop="title"
                  class="l-breadcrumb-item-link-title">{{ __('subtitle.upload') }}</span>
        </a>
    </li>
@endsection
...
@section('content')
    <div class="container">
        <h2 class="upload-title">
            {{ __('subtitle.upload') }} - {{ $torrent->name }}
        </h2>
        <div class="well">
            ...
            <form method="POST" action="{{ route('subtitles.store') }}" id="form_upload_subtitle"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input class="upload-form-file" name="subtitle_file" accept=".srt,.ass,.sup,.zip" type="file"
                               id="subtitle_file">
                    </div>
                </div>
                <div class="form-group">
...
@endif
                ...
                <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-2">
                        <input class="btn btn-primary" type="submit" value="{{ __('subtitle.ul') }}">
                    </div>
                </div>
            </form>
        </div>
