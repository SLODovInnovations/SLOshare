...
@section('breadcrumb')
    <li>
        <a href="{{ route('instructions') }}" itemprop="url" class="l-breadcrumb-item-link">
            <span itemprop="title" class="l-breadcrumb-item-link-title">{{ __('page.title-instructions') }}</span>
        </a>
    </li>
@endsection
