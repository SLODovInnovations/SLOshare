...
@section('title', 'NAPAKA 307: Začasna preusmeritevt!')
...
@section('description')
    ...
    <p>Prosimo, oprostite za nevšečnosti.</p>
    <p>Trenutno gradimo ali prenavljamo to funkcijo.</p>
    <p>Nič hudega, tudi mi smo navdušeni!</p>
@endsection
