...
@section('title')
    NAPAKA 307: Začasna preusmeritevt!
@stop

@section('container')
    <h1 class="mt-5 text-center">
        <i class="{{ config('other.font-awesome') }} fa-exclamation-circle text-warning"></i> NAPAKA 307: Začasna
        preusmeritevt!
    </h1>
    ...
    <div class="text-center">
        ...
        <p>
            Prosimo, oprostite za nevšečnosti.
            <br/> Trenutno gradimo ali prenavljamo to funkcijo.
        </p>
        <p>
            Nič hudega, tudi mi smo navdušeni!
        </p>
    </div>
@stop
