    <div class="torrent box container single">
        <div class="movie-wrapper">
            ...
            <div class="movie-poster">
                <img src="{{ $collection->poster ? tmdb_image('poster_big', $collection->poster) : '/img/SLOshare/cartoon_no_image_400x600.jpg' }}"
            ...
            <div class="meta-info">
                ...
                <div class="movie-backdrop"
                     style="background-image: url('{{ $collection->backdrop ? tmdb_image('back_big', $collection->backdrop) : '/img/SLOshare/cartoon_no_image_banner.jpg' }}');"></div>
