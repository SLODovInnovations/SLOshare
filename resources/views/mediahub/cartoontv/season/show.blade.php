                            ...
                            <div class="card is-torrent" style="margin-top: 0; margin-bottom: 20px; height: auto;">
                                ...
                                <div class="card_body">
                                    <div class="body_poster">
                                        <img src="{{ isset($episode->still) ? tmdb_image('still_mid', $episode->still) : '/img/SLOshare/mediahub_no_image_banner.jpg' }}"
                                             class="show-poster">
                                    </div>
