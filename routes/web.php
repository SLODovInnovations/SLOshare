...
Route::group(['middleware' => 'language'], function (): void {
    ...
    */
    Route::group(['middleware' => ['auth', 'twostep', 'banned']], function (): void {
        ...
        Route::group(['prefix' => 'pages'], function (): void {
            ...
            Route::get('/donationslo', [App\Http\Controllers\PageController::class, 'donationslos'])->name('donationslos');
    ...
    */
    Route::group(['prefix' => 'mediahub', 'middleware' => ['auth', 'twostep', 'banned']], function (): void {
        ...
        // Cartoon TV
        Route::get('/cartoon-tv/{id}', [App\Http\Controllers\MediaHub\CartoonTvController::class, 'show'])->name('mediahub.cartoontvs.show');

        // Cartoon TV Season
        Route::get('/cartoon-tv/season/{id}', [App\Http\Controllers\MediaHub\CartoonTvSeasonController::class, 'show'])->name('mediahub.cartoontvs.season.show');
    });
    ...
    */
    Route::group(['prefix' => 'dashboard', 'middleware' => ['auth', 'twostep', 'modo', 'banned']], function (): void {
        ...
        // Backup System
        Route::group(['prefix' => 'backups', 'middleware' => ['sysop']], function (): void {
        ...
        // VideoHome System
        Route::group(['prefix' => 'homes'], function (): void {
            Route::name('staff.homes.videos.')->group(function (): void {
        ...
        Route::group(['prefix' => 'SLOSHARE'], function (): void {
            Route::get('/', [App\Http\Controllers\Staff\VersionController::class, 'checkVersion']);
        });

        // Commands
        Route::group(['prefix' => 'commands', 'middleware' => ['sysop']], function (): void {
        ...
        // Laravel Log Viewer
        Route::get('/laravel-log', App\Http\Livewire\LaravelLogViewer::class)->middleware('sysop')->name('staff.laravellog.index');
