...
class AutoRevokePermissions extends Command
{
     ...
     * @var string
     */
    protected $description = 'Prekliče določena dovoljenja uporabnikom, ki imajo več kot X aktivnih opozoril';
    ...
    public function handle(): void
    {
        ...
        $this->comment('Avtomatizirana uporabniška dovoljenja Preklic Ukaz dokonča');
    }
}
