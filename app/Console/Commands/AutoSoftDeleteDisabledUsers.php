...
class AutoSoftDeleteDisabledUsers extends Command
{
     ...
     * @var string
     */
    protected $description = 'Uporabniški račun mora biti v skupini onemogočenih vsaj x dni';
    ...
    public function handle(): void
    {
        ...
        $this->comment('Ukaz za samodejno mehko brisanje onemogočenih uporabnikov je dokončan');
    }
}
