...
class Bbcode
{
    private array $parsers = [
        ...
        'namedquote' => [
            'openBbcode'  => '/^\[quote=([^<>"]*?)\]/i',
            'closeBbcode' => '[/quote]',
            'openHtml'    => '<ul class="media-list comments-list"><li class="media" style="border-left-width: 5px; border-left-style: solid; border-left-color: #01bc8c;"><div class="media-body"><strong><span><i class="fas fa-quote-left"></i> Citiranje $1 :</span></strong><div class="pt-5">',
            'closeHtml'   => '</div></div></li></ul>',
        ],
        'namedlink' => [
            'openBbcode'  => '/^\[url=(.*?)\]/i',
